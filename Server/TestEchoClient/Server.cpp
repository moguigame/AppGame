...
AGBase::IConnect* CServer::Connect(const char* strIP,int nPort,AGBase::IConnectCallback* callback){
	AGBase::IConnect* pRetConnect = m_pPool->Connect(strIP,nPort,callback);
	if ( !pRetConnect ){
