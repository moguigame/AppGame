...
INT64 CMoGuiServerSocket::s_TotalInPacket = 0;
INT64 CMoGuiServerSocket::s_TotalOutPacket = 0;
INT64 CMoGuiServerSocket::s_TotalInByte = 0;
INT64 CMoGuiServerSocket::s_TotalOutByte = 0;

INT64 CMoGuiServerSocket::s_LastTotalInByte = 0;
INT64 CMoGuiServerSocket::s_LastTotalOutByte = 0;
INT64 CMoGuiServerSocket::s_LastTotalInPacket = 0;
INT64 CMoGuiServerSocket::s_LastTotalOutPacket = 0;
...
void CMoGuiServerSocket::Stop(int curTime)
{
	m_SocketState = SOCKET_ST_STOP;
	m_nStopTime = curTime;
}
unsigned int CMoGuiServerSocket::GetStopTime()
{
	return m_nStopTime;
}
...
int CMoGuiServerSocket::FinishMsg(UINT16 XYID,int TotalXYLen)
{
	m_nRecvPackets++;
