...
namespace DeZhou
{
	...
	const short  GameXYID_ReqPlayPai                    = GameXYID_Start+21;
	const short  GameXYID_RespPlayPai                   = GameXYID_Start+22;
	const short  GameXYID_PlayerPlayPai                 = GameXYID_Start+23;
	...
	struct msgStartPlayerInfo
	{
		...
		friend bostream& operator<<( bostream& bos, const msgStartPlayerInfo& src )
		{
			bos << src.m_SitID;
			bos << src.m_nServiceMoney;
			bos << src.m_nTableMoney;
			for ( int i=0;i<src.HandPaiCount;++i)
			{
				bos << src.m_HandPai[i];
			}
		...
		friend bistream& operator>>( bistream& bis, msgStartPlayerInfo& src )
		{
			src.ReSet();

			bis >> src.m_SitID;
			bis >> src.m_nServiceMoney;
			bis >> src.m_nTableMoney;
			for ( int i=0;i<src.HandPaiCount;++i)
			{
				bis >> src.m_HandPai[i];
			}
	...
	struct GameDeZhou_SitPlayerInfo
	{
		...
		friend bostream& operator<<( bostream& bos, const GameDeZhou_SitPlayerInfo& spi )
		{
			...
			InString(bos,spi.m_MaxPai,MAX_STRING_SIZE);
		...
		friend bistream& operator>>( bistream& bis, GameDeZhou_SitPlayerInfo& spi )
		{
			...
			OutString(bis,spi.m_MaxPai,MAX_STRING_SIZE);
	...
	struct GameDeZhou_ReqPlayPai
	{
		enum { XY_ID = GameXYID_ReqPlayPai };
		enum { HandPaiCount = 13,};

		unsigned char       m_CurPlayerSitID;
		unsigned char       m_HandPai[HandPaiCount];

		GameDeZhou_ReqPlayPai() { ReSet(); }
		void ReSet(){ memset(this,0,sizeof(*this));}

		friend bostream& operator<<( bostream& bos, const GameDeZhou_ReqPlayPai& src )
		{
			bos << src.m_CurPlayerSitID;
			for ( int i=0;i<src.HandPaiCount;++i)
			{
				bos << src.m_HandPai[i];
			}
		...
		friend bistream& operator>>( bistream& bis, GameDeZhou_ReqPlayPai& src )
		{
			src.ReSet();

			bis >> src.m_CurPlayerSitID;
			for ( int i=0;i<src.HandPaiCount;++i)
			{
				bis >> src.m_HandPai[i];
			}
	...
	struct GameDeZhou_RespPlayPai
	{
		enum { XY_ID = GameXYID_RespPlayPai };
		enum { SUCCESS,Error_XiangGong,};

		unsigned char       m_Flag;

		GameDeZhou_RespPlayPai() { ReSet(); }
		void ReSet(){ memset(this,0,sizeof(*this));}

		friend bostream& operator<<( bostream& bos, const GameDeZhou_RespPlayPai& src )
		{
			bos << src.m_Flag;
		...
		friend bistream& operator>>( bistream& bis, GameDeZhou_RespPlayPai& src )
		{
			src.ReSet();
	...
	struct GameDeZhou_PlayerPlayPai
	{
		enum { XY_ID = GameXYID_PlayerPlayPai };
		...
		GameDeZhou_PlayerPlayPai() { ReSet(); }
		void ReSet(){ memset(this,0,sizeof(*this));}

		friend bostream& operator<<( bostream& bos, const GameDeZhou_PlayerPlayPai& src )
		{
			bos << src.m_CurPlayerSitID;
			for ( int i=0;i<src.HandPaiCount;++i)
			{
		...
		friend bistream& operator>>( bistream& bis, GameDeZhou_PlayerPlayPai& src )
		{
			src.ReSet();
