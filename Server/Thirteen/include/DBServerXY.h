...
namespace DBServerXY
{
	...
	const short  DBServerXYID_DB_FRIST                             = MOGUI_FIRST_SERVER+500;
	const short  DBServerXYID_WDB_USERFRIEND                       = DBServerXYID_DB_FRIST+1;
	const short  DBServerXYID_WDB_WINLOSS                          = DBServerXYID_DB_FRIST+2;
	const short  DBServerXYID_WDB_WINLOSSLIST                      = DBServerXYID_DB_FRIST+3;

	const short  DBServerXYID_RespWinLoss                          = DBServerXYID_DB_FRIST+4;
	const short  DBServerXYID_RespWinLossList                      = DBServerXYID_DB_FRIST+5;

	const short  DBServerXYID_WDB_MatchResult                      = DBServerXYID_DB_FRIST+6;
	const short  DBServerXYID_WDB_MatchWinLoss                     = DBServerXYID_DB_FRIST+7;

	const short  DBServerXYID_WDB_ReqCheckGameInfo                 = DBServerXYID_DB_FRIST+8;

	const short  DBServerXYID_WDB_IncomeAndPay                     = DBServerXYID_DB_FRIST+10;
	const short  DBServerXYID_WDB_SendMoney                        = DBServerXYID_DB_FRIST+11;
	const short  DBServerXYID_WDB_ShowFace                         = DBServerXYID_DB_FRIST+16;
	const short  DBServerXYID_WDB_SendGift                         = DBServerXYID_DB_FRIST+21;
	const short  DBServerXYID_WDB_SoldGift                         = DBServerXYID_DB_FRIST+22;
	const short  DBServerXYID_WDB_CreateTable                      = DBServerXYID_DB_FRIST+23;
	const short  DBServerXYID_WDB_ChatMsg                          = DBServerXYID_DB_FRIST+24;

	const short  DBServerXYID_WDB_MaxPai                           = DBServerXYID_DB_FRIST+40;
	const short  DBServerXYID_WDB_MaxWin                           = DBServerXYID_DB_FRIST+41;
	const short  DBServerXYID_WDB_MaxMoney                         = DBServerXYID_DB_FRIST+42;

	const short  DBServerXYID_WDB_PlayerAction                     = DBServerXYID_DB_FRIST+46;
	const short  DBServerXYID_WDB_PlayerClientError                = DBServerXYID_DB_FRIST+47;

	const short  DBServerXYID_WDB_PlayerAward                      = DBServerXYID_DB_FRIST+51;

	const short  DBServerXYID_ReportPlayerOnline                   = DBServerXYID_DB_FRIST+101;
	...
	struct DBS_ReqServerConnect
	{
		...
		{
			bos << rsc.m_ServerID;
			bos << rsc.m_ServerClass;
			InString(bos,rsc.m_strSession,MAX_URL_SIZE);
		...
		friend bistream& operator>>( bistream& bis, DBS_ReqServerConnect& rsc )
		{
			...
			bis >> rsc.m_ServerID;
			bis >> rsc.m_ServerClass;
			OutString(bis,rsc.m_strSession,MAX_URL_SIZE);
	...
	struct DBS_ReqServerPlayerLogin
	{
		...
		friend bostream& operator<<( bostream& bos, const DBS_ReqServerPlayerLogin& srl )
		{
			...
			InString(bos,srl.m_UserName,MAX_USERNAME_SIZE);
			InString(bos,srl.m_Password,MAX_PASSWORD_SIZE);
			InString(bos,srl.m_HardCode,MAX_HARDCODE_SIZE);
			InString(bos,srl.m_strSession,MAX_URL_SIZE);		
			InString(bos,srl.m_strLoginKey,MAX_URL_SIZE);
		...
		friend bistream& operator>>( bistream& bis, DBS_ReqServerPlayerLogin& srl )
		{
			...
			OutString(bis,srl.m_UserName,MAX_USERNAME_SIZE);
			OutString(bis,srl.m_Password,MAX_PASSWORD_SIZE);
			OutString(bis,srl.m_HardCode,MAX_HARDCODE_SIZE);
			OutString(bis,srl.m_strSession,MAX_URL_SIZE);
			OutString(bis,srl.m_strLoginKey,MAX_URL_SIZE);
	...
	struct DBS_RespServerPlayerLoginData
	{
		...
		friend bostream& operator<<( bostream& bos, const DBS_RespServerPlayerLoginData& srld )
		{
			...
			bos << srld.m_PID;
			bos << srld.m_Socket;
			InString(bos,srld.m_SessionKey,MAX_URL_SIZE);
		...
		friend bistream& operator>>( bistream& bis, DBS_RespServerPlayerLoginData& srld )
		{
			...
			bis >> srld.m_PID;
			bis >> srld.m_Socket;
			OutString(bis,srld.m_SessionKey,MAX_URL_SIZE);
	...
	struct DBS_ReqBotPlayer
	{
		...
		short                       m_ServerID;
		int                         m_StartPlayerNumber;
		int                         m_EndPlayerNumber;
	...
	struct DBS_BotPlayerData
	{
		...
		friend bostream& operator<<( bostream& bos, const DBS_BotPlayerData& bpd )
		{
			...
			bos << bpd.m_DrawnTimes;
			bos << bpd.m_EscapeTimes;
			bos << bpd.m_nGameTime;

			InString(bos,bpd.m_MaxPai,MAX_STRING_SIZE);
		...
		friend bistream& operator>>( bistream& bis, DBS_BotPlayerData& bpd )
		{
			...
			bis >> bpd.m_DrawnTimes;
			bis >> bpd.m_EscapeTimes;
			bis >> bpd.m_nGameTime;

			OutString(bis,bpd.m_MaxPai,MAX_STRING_SIZE);
	...
	{
		enum { XY_ID = DBServerXYID_WDB_USERFRIEND };
	...
	struct WDB_WinLoss
	{
		enum { XY_ID = DBServerXYID_WDB_WINLOSS };
	...
	{
		enum { XY_ID = DBServerXYID_WDB_WINLOSSLIST };
	...
	{
		enum { XY_ID = DBServerXYID_WDB_IncomeAndPay };
	...
	{
		enum { XY_ID = DBServerXYID_WDB_SendMoney };
	...
	struct WDB_ShowFace
	{
		enum { XY_ID = DBServerXYID_WDB_ShowFace };
